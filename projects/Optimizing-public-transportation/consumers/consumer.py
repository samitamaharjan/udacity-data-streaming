...
class KafkaConsumer:
    ...
    def on_assign(self, consumer, partitions):
        ...
        for partition in partitions:
            if self.offset_earliest:
                ...
                logger.info("OFFSET_BEGINNING failure!!")
    ...
    def _consume(self):
        ...
        # is retrieved.
        logger.info("consume the message ... ")
        ...
        try:
            ...
            if message is None:
                ...
                logger.error(
                    f"Error from consumer for the topic - {topic_name_pattern}: {message.error()}"
                )
                return 0
    ...
    def close(self):
        ...
        logger.info("Cleaning up opened kafka consumers")
        self.consumer.close()